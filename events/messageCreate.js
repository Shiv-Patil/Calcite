...
module.exports = {
  ...
  async execute (client, message) {
    ...
    if (message.content === 'calcite deploy commands' && message.author.id === "398061543373406208") {
    ...
    else if (message.content === 'calcite deploy globally commands' && message.author.id === "398061543373406208") {
      const cmd_data = client.commands.map(({ execute, ...data }) => data);
      message.react("<:CheemsPrayDorime:869938135725903913>")
